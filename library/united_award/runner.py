...
def _goal(inputs: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "  1g. Click 'Sign in'.",
        "  1h. wait 8",
        "  1i. If SMS 2FA is requested: action=read_sms_code sender=26266 keyword=united.",
        "      Enter the received code and click Submit/Verify.",
        "      wait 5",
        "  1i2. IMPORTANT: If you see a checkbox like 'Remember me', 'Keep me logged in',",
        "       'Remember this device', or 'Don\'t ask again', CHECK IT before continuing.",
        "       This saves the session so future logins skip 2FA.",
        ...
        "",
        "=== STEP 3B — SWITCH TO MILES PRICING (MANDATORY) ===",
        "You MUST do this step. Do NOT skip it. Do NOT go to Step 4 until you complete this.",
        "Above the flight results, on the right side, you will see 'Show price in:' with two tabs: 'Money' and 'Money + Miles'.",
        "  3b-1. Click the 'Money + Miles' tab/link (it is next to the currently selected 'Money' tab).",
        "  3b-2. wait 3",
        "  3b-3. The DATE FIELD MAY GO BLANK after switching — this is expected!",
        ...
        "",
        "If you CANNOT find a Money + Miles toggle (not logged in), that is OK.",
        "Report the cash prices instead.",
        "",
        "=== STEP 3C — SCAN ALL DATES IN THE DATE STRIP (30-DAY WINDOW) ===",
        "IMPORTANT: There is a DATE STRIP/CAROUSEL above the flights showing ~7 dates.",
        "Each date shows a miles price or dollar price (e.g., 'Fri 2/28: 39.8k miles').",
        "",
        "3c-1. Read ALL dates and prices currently visible in the date strip.",
        "3c-2. Click the RIGHT ARROW '>' at the right end of the date strip. wait 5.",
        "3c-3. Read ALL new dates and prices.",
        "3c-4. Click '>' again. wait 5. Read all dates and prices.",
        "3c-5. Click '>' again. wait 5. Read all dates and prices.",
        "3c-6. Click '>' again. wait 5. Read all dates and prices.",
        f"You have now scanned ~30 days from {depart_date.strftime('%b %-d')}.",
        "Include all of these in your REPORT at the end.",
        "",
        "=== STEP 4 — SCREENSHOT ===",
        ...
        "Report what you see. Prices will show as $X + Yk miles (cash + miles). Report:",
        "",
        "A) DATE STRIP:",
        ...
        "",
        "If prices show in dollars only (no miles), still report them:",
        "FLIGHT: HH:MM-HH:MM | $XXX | stops | cabin",
        "Note: 'Prices shown in USD only, no miles'",
        "",
