...
def _goal(inputs: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "Now switch the 'Show price in:' dropdown to 'Money + Miles':",
        "  3b-1. Click the dropdown labeled 'Show price in:' (currently says 'Money').",
        "  3b-2. Select 'Money + Miles' from the dropdown options.",
