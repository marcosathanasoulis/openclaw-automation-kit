...
def _run_agent_only(inputs: Dict[str, Any], observations: List[str]) -> Dict[str, Any]:
    ...
    goal = "\n".join([
        f"Search for Delta SkyMiles award flights {origin} to {dest}, {travelers} pax.",
        ...
        "Delta shows a 'Flexible Dates' calendar after searching. It has a 7-day grid:",
        "  - Each column is a date (like 'Mon, Mar 2', 'Tue, Mar 3', etc.)",
        "  - Each cell shows a miles price (like '108,200 miles +$6' or 'LOWEST 108,200')",
        "  - TRUST THE SCREENSHOT — even if accessibility text shows nothing, the screenshot",
        "    WILL show the dates and prices. READ THEM FROM THE SCREENSHOT IMAGE.",
        "",
        "If you still see a loading spinner, wait 15 more seconds and screenshot again.",
        "If after 60 total seconds it still has not loaded, report what you see and done.",
        "",
        "=== STEP 6 — SCAN ALL DATES ===",
        "The calendar shows 7 dates at a time. Advance to scan more dates:",
        "",
        "6a. Read ALL 7 visible dates and their exact miles prices from the SCREENSHOT.",
        "6b. Look for a right arrow button at the right edge of the date grid.",
        "    If found: click it, wait 5, screenshot, read new 7 dates and prices.",
        "6c. Click right arrow again if available. wait 5. Screenshot. Read dates and prices.",
        "6d. Click right arrow again if available. wait 5. Screenshot. Read dates and prices.",
        "6e. Click right arrow again if available. wait 5. Screenshot. Read dates and prices.",
        f"You have now scanned ~{days_ahead} days of availability.",
        "",
        "=== STEP 7 — SCREENSHOT ===",
        "Take a final screenshot showing the calendar with prices.",
        "",
        "=== STEP 8 — DONE ===",
        "done",
        "Report ALL dates and prices you saw in screenshots:",
        "DATE_STRIP: [Mon Mar 2]: [miles] miles | [Tue Mar 3]: [miles] miles | ...",
        "CHEAPEST: [date] — [miles] miles",
        "",
        "CRITICAL RULES:",
        "  - Only report exact prices you SAW in screenshots. Read number carefully.",
        "  - Do NOT round, estimate, or make up numbers.",
        "  - Report the EXACT miles shown (108,200 NOT 108k NOT 108,000).",
        f"  - Report all dates found, even above {max_miles:,} miles.",
        "  - If no dates have award availability, report 'No award availability found'.",
    ])
