...
def _goal(inputs):
    ...
    lines = [
        ...
        "Navigate to https://www.ana.co.jp/en/us/amc/login/",
        "If you see a login form:",
        "  1a. credentials for www.ana.co.jp",
        "  1b. Enter the ANA Mileage Club number into the member number field",
        "  1c. Enter the password into the password field",
        "  1d. Click the Log In / Sign In button",
        "  1e. wait 5",
        "If already logged in (you see a member name/welcome), skip login.",
        "",
        ...
        "- Do NOT waste steps trying to log in — ANA award search works without login",
